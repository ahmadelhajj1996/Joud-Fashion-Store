                    ...
                    <div className="px-[6%] flex flex-col gap-y-3 border-b-[1px]  border-rose-500 ">
                      ...
                      <div className=" py-8">
                        ...
                        <div className="flex  gap-x-4  mt-10">
                            <button disabled={!sizeSelected} onClick={() => {  dispatch(addToCart(product, current, 1, toastr)); setSize('')  }} className="bg-color hover:bg-color-hovered">Add to bag</button>
                            <button onClick={() => dispatch(addToFavorites(product, current, toastr))} className="bg-color hover:bg-color-hovered">Add to favourites</button>
                          </div>
